...
export const dashboardActionContracts = [
  ...
  },
  {
    ...
    target: { type: "route", value: "/dashboard/account, /dashboard/imports, /dashboard/trips, /dashboard/profile/stats, mailto:support@almidy.app, /dashboard/profile, /terms, /privacy" },
    requiredAuth: "dashboard-session",
    requiredPermissions: ["signed-in-user"],
