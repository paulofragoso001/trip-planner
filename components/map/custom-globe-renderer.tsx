...
function LoadedTripsOverviewMapRenderer({
  ...
  if (!mapReady) {
    return (
      <div
        className="absolute inset-0 grid place-items-center bg-[#090e14] text-center text-xs font-bold tracking-[0.2em] text-white/40"
  ...
  return (
    <div
      className={["absolute inset-0 overflow-visible bg-[#090e14]", className].filter(Boolean).join(" ")}
