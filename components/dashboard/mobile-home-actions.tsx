...
export function MobileHomeAction({
  ...
  return (
    <Link
      className={cn(
        "grid min-h-[4.75rem] grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 rounded-[1.45rem] px-4 py-2.5 text-left transition focus:outline-none focus:ring-4 focus:ring-orange-300/20",
        primary
...
export function MobileHomeTile({
  ...
  return (
    <Link
      className="grid min-h-[5.25rem] place-items-center gap-1.5 rounded-[1.45rem] bg-white/[0.075] px-3 py-3 text-center text-sm font-black text-white ring-1 ring-white/10 transition hover:bg-white/12 focus:outline-none focus:ring-4 focus:ring-orange-300/20"
      href={href}
    >
